This project is a Game UI for pixi game engine, it is an adapter between [pixi.js](https://github.com/GoodBoyDigital/pixi.js) and [Canvas ToolKit](https://github.com/drawapp8/cantk).
